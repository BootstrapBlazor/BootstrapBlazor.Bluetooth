    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        try
        {
            if (firstRender)
            {
                ...
                module = await JS!.InvokeAsync<IJSObjectReference>("import", "./_content/BootstrapBlazor.Bluetooth/lib/batterylevel/app.js" + "?v=" + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version);
